from .filters import numba_color2gray as gray
from .filters import numba_color2sepia as sepia
"""
En gruppelærer sa at jeg skulle skrive .filters
"""
...
def grayscale_image(input_filename, output_filename=None):
    ...
    if output_filename != None:
        return gray.numba_color2gray(output_filename)
    else:
        return gray.numba_color2gray(input_filename)
...
def sepia_image(input_filename, output_filename=None):
    ...
    """
    if output_filename != None:
        return sepia.numba_color2sepia(output_filename)
    else:
        return sepia.numba_color2sepia(input_filename)